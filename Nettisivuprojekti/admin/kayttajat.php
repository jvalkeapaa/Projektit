<!--
 Sivusto jolta admin voi katsoa luotuja käyttäjiä. Käyttäjiä pääsee muokkaamaan alhaalla sijaitsevasta napista.
 -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              ...
                              while($row = mysqli_fetch_assoc($result)) {
                                echo "<tr><td>" . $row["id"]. "</td><td>" . $row["nimi"]. "</td><td>" . $row["username"]. "</td><td>" . $row["email"]. "</td><td>" . $row["created_at"]. "</td>";
                              }
                            } else {
                              echo "0 results";
                            }
                        ...
                        <div>
                        <a href="muokkaa.php">
                            <button type="button" class="btn btn-primary m-2">Muokkaa käyttäjiä</button>
                            </a>
                            </div>
                    </div>
                </div>

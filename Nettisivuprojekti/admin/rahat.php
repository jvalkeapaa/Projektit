<!--
 Sivusto jolle on luotu kuvitteellisia menoja sekä tuloja.

 !! Sivustolle ei ole luotu lisäys-sivua. Kaikki tulot pitää toistaiseksi lisätä SQL-tiedoston kautta. !!
 -->
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Varaukset</a>
                            <a href="typography.html" class="dropdown-item">Käyttäjät</a>
                            <a href="element.html" class="dropdown-item active">Myynnit</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Myynnit ja menot</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr align="center" class="text-white">
                                    ...
                                    <th scope="col">Tulot</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
                            $sql = "SELECT id, pvm, tapahtuma, hinta FROM tulos WHERE hinta > 0";

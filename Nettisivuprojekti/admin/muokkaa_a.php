<!--
 Sivusto jolla yritin luoda toimivan käyttäjien muokkaamisen.
 -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Muokkaa käyttäjän tietoja</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT id, nimi, username, email, password FROM accounts";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              ...
                              while($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td> <a href="insert.php?id=<?php echo $row['id'];?>
                                &nimi=<?php echo $row['nimi'];?>
                                &username=<?php echo $row['username'];?>
                                &email=<?php echo $row['email'];?>">
                                Tallenna </a> </td>
                                <td> <a href="muokkaa.php?id=<?php echo $row['id'];?>">
                                Takaisin </a> </td>
                                <?php
                              }
                            } else {
